...
// import SpecialitySelect from '../PaidInvoice';
// import { TouchableOpacity, Text } from '../../../../../components';
// import { colors, i18n } from '../../../../../services';
// import SelectDoctor from '../UnpaidInvoice';
...
//                     <>
//                         <PageContainer>
//                             <SelectDoctor route={{ params: {} }} header={false} navigation={navigation} />
//                         </PageContainer>
//                         <PageContainer>
...
//         }}>
//         <>
//             <Text style={[styles().buttonText, { color: hilighted ? colors.whiteAbsolute : colors.black }]}>
//                 {children}
//             </Text>
//             <View
//                 style={{
