...
import {getAllOrders} from '../../../../../store/actions/main/restaurantActions';

const RestaurantInvoices = ({navigation}) => {
    ...
    if (data.mobileNo.length > 0) {
      dispatch(
        getAllOrders(
          ...
          () => {
            setLoading(false);
            navigation.navigate(routesNames.restaurantInvoicesOverView, {
              mobileNo,
            });
          },
          () => {
